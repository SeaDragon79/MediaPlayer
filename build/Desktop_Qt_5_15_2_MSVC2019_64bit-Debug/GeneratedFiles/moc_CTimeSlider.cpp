...
QT_MOC_LITERAL(1, 12, 15), // "sig_SliderMoved"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "value"
QT_MOC_LITERAL(4, 35, 15), // "onSliderPressed"
QT_MOC_LITERAL(5, 51, 13), // "onSliderMoved"
QT_MOC_LITERAL(6, 65, 8), // "position"
QT_MOC_LITERAL(7, 74, 15) // "onSliderRelease"

    },
    "CTimeSlider\0sig_SliderMoved\0\0value\0"
    "onSliderPressed\0onSliderMoved\0position\0"
    "onSliderRelease"
};
...
void CTimeSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CTimeSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_SliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onSliderPressed(); break;
        case 2: _t->onSliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->onSliderRelease(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTimeSlider::sig_SliderMoved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CTimeSlider::sig_SliderMoved(int _t1)
{
