...
QT_MOC_LITERAL(4, 37, 15) // "sig_VolumeMoved"

    },
    "CVolumeButton\0sig_VolumeValue\0\0value\0"
    "sig_VolumeMoved"
};
...
void CVolumeButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sig_VolumeMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CVolumeButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CVolumeButton::sig_VolumeMoved)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void CVolumeButton::sig_VolumeMoved(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
