...
QT_MOC_LITERAL(7, 82, 15), // "sig_SliderValue"
QT_MOC_LITERAL(8, 98, 5), // "value"
QT_MOC_LITERAL(9, 104, 15), // "sig_SliderMoved"
QT_MOC_LITERAL(10, 120, 15), // "onSliderPressed"
QT_MOC_LITERAL(11, 136, 13), // "onSliderMoved"
QT_MOC_LITERAL(12, 150, 8), // "position"
QT_MOC_LITERAL(13, 159, 15) // "onSliderRelease"

    },
    "CVideoWidgetTopWidget\0sig_OpenFile\0\0"
    "filelist\0sig_OpenFloder\0path\0"
    "sig_OpenPlayList\0sig_SliderValue\0value\0"
    "sig_SliderMoved\0onSliderPressed\0"
    "onSliderMoved\0position\0onSliderRelease"
};
...
void CVideoWidgetTopWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CVideoWidgetTopWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 3: _t->sig_SliderValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->sig_SliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->onSliderPressed(); break;
        case 6: _t->onSliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->onSliderRelease(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CVideoWidgetTopWidget::sig_SliderValue)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (CVideoWidgetTopWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CVideoWidgetTopWidget::sig_SliderMoved)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 3
void CVideoWidgetTopWidget::sig_SliderValue(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 4
void CVideoWidgetTopWidget::sig_SliderMoved(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
